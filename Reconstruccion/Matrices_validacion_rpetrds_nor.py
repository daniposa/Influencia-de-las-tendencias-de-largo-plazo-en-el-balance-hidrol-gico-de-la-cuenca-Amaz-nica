...
#==============================================================================
#------------------------------------------------------------------------------
# -- CONSTRUCCIÓN MATRICES DE VALIDACION DE LA RECONSTRUCCIÓN
#------------------------------------------------------------------------------
#==============================================================================
"""
...
raiz = 'H:/00_Backup_Tesis/2019-1Final/01_DATOS/InfoOrganizada/'

ruta_csvtesis = raiz + 'datos_crudos_rpetrds.csv'
all_ds=pd.read_csv(ruta_csvtesis,parse_dates=True,header=0,index_col=0)

ruta_reconstruccion_R = raiz + 'R/R_media_mensual/reconstruccion_nor/' 
ruta_reconstruccion_P = raiz + 'P/P_media_mensual/reconstruccion_nor/' 
ruta_reconstruccion_ETR = raiz + 'ETR/ETR_media_mensual/reconstruccion_nor/'
ruta_reconstruccion_dS = raiz + 'dS/dS_media_mensual/reconstruccion_nor/'

ruta_metadatos = raiz + 'Q/ANA/usar/metadatos10.csv'
#ruta_experimentos_R='experimentos/'
ruta_fig_experimentos_R = ruta_reconstruccion_R + 'figuras/'
ruta_fig_experimentos_P = ruta_reconstruccion_P + 'figuras/'
ruta_fig_experimentos_ETR = ruta_reconstruccion_ETR + 'figuras/'
ruta_fig_experimentos_dS = ruta_reconstruccion_dS + 'figuras/'
...
#==============================================================================
# -- Construir matriz de series para reconstrucción
#==============================================================================
...
#    elif serie[:-8] == 'ETR_':
#        experimento_st.to_csv( ruta_reconstruccion_ETR + serie + '.csv')
all_ds_reconstruidas.to_csv( raiz + 'datos_recons_rpetrds_nor.csv')
